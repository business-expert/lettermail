...
class pdf extends TCPDF {
	...
	public function Header() {
		...
		$this->Image('http://dev.armopelus.com/oglasnik/assets/images/logo_oglasnik.png', 120, 10, 75, 0, 'PNG', 'http://www.e-oglasnik.com');
	...
	public function CreateTextBox($textval, $x = 0, $y, $width = 0, $height = 10, $fontsize = 10, $fontstyle = '', $align = 'L') {
		...
		$this->SetFont("freeserif", $fontstyle, $fontsize);
