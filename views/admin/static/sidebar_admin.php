	...
	<aside id="sidebar" class="column">
		...
		<ul class="toggle">
			<li class="icn_view_users"><a href="<?php echo base_url();?>admin/uporabniki">Poglej uporabnike</a></li>
                ...
                <h3>Komercialisti</h3>
		<ul class="toggle">
			<li class="icn_view_users"><a href="<?php echo base_url();?>admin/komers">Poglej komercialiste</a></li>
			<li class="icn_profile"><a href="<?php echo base_url();?>admin/newKomer">Ustvari komercialista</a></li>
			<li class="icn_categories"><a href="<?php echo base_url();?>admin/statKomer">Poglej statistiko komercialista</a></li>

		</ul>
                <h3>Vsebina</h3>
		<ul class="toggle">
			<li class="icn_categories"><a href="<?php echo base_url();?>admin/content">Pregled strani</a></li>
			<li class="icn_new_article"><a href="<?php echo base_url();?>admin/newContent">Nova stran</a></li>
		</ul>
